...
from .views import index,carro,sala, login, aprovar_carro,aprovar_sala,reservas,reserva_mes,reservas_json_carro
...
urlpatterns = [
    ...
    path('reservas/<str:carro>',reservas,name='reservas'),
    path('reservas/<db>/<mes>',reserva_mes,name='reservaMes'),
    path('json/<str:carro>',reservas_json_carro,name='json')
]